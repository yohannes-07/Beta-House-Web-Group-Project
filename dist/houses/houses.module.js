...
const housescheema_scheema_1 = require("../houseScheema/housescheema.scheema");
let HousesModule = class HousesModule {
};
HousesModule = __decorate([
    (0, common_1.Module)({
        imports: [mongoose_1.MongooseModule.forFeature([{ name: 'House', schema: housescheema_scheema_1.HouseSchema }])],
